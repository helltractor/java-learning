...
import com.helltractor.demo.annotation.MyAnnotation;
import com.helltractor.demo.entity.User;
import com.helltractor.demo.service.GetClassService;

public class ReflectionTest {

    // 通过Class.forName()获取
    String className = "com.helltractor.demo.entity.User";
    Class<?> clazz = GetClassService.getClassForName(className);

    ReflectionTest() throws ClassNotFoundException {
    }
